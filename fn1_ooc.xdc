...
set_property PACKAGE_PIN E12 [get_ports pll_clk1]
...
## Use CW305's onboard PLL clock (pll_clk1)
#create_clock -period 10.000 -name pll_clk1 -waveform {0.000 5.000} [get_nets pll_clk1]

## Clock signal
#set_property -dict { PACKAGE_PIN W5   IOSTANDARD LVCMOS33 } [get_ports ap_clk]
...
#set_property PACKAGE_PIN A7 [get_ports {p_9[0]}]
...
#set_property PACKAGE_PIN T2 [get_ports {p_5_address0[0]}]
#set_property PACKAGE_PIN T3 [get_ports {p_5_address0[1]}]
#set_property PACKAGE_PIN T4 [get_ports {p_5_address0[2]}]

# DIP switches
#set_property PACKAGE_PIN J16 [get_ports {p[12]}]
#set_property PACKAGE_PIN K16 [get_ports {p[13]}]
#set_property PACKAGE_PIN L14 [get_ports {p[14]}]
#set_property PACKAGE_PIN K15 [get_ports {p[15]}]
